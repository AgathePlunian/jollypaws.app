...
<section class="team-page">
  <header class="team-page-header">
   <h1>Our team</h1>
   <p>ResilEyes was founded by Annaïg and Yannick, both healthcare professionals and patient partners in Post-Traumatic Stress Disorder.</p>
 </header>
...
<!--  PREMIÈRE LIGNE -->
  ...
  <div class="card-team">
    <div class="ID-picture-container">
      <img src="/images/team-page/annaig-bg.png" alt="Portrait of Annaïg Trescos">
    </div>
    <div class="text-ID-card">
...
<div class="team-cards-container">
  ...
  <div class="card-team">
    <div class="ID-picture-container">
      <img src="/images/team-page/paul-bg.png" alt="Portrait of Paul Ledesma">
    </div>
    <div class="text-ID-card">
  ...
  <div class="card-team">
    <div class="ID-picture-container">
      <img src="/images/team-page/marion-bg.png" alt="Portrait of Marion Dragée">
    </div>
    <div class="text-ID-card">
